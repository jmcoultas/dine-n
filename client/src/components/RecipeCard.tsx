...
import { Clock, Users, Heart, ChefHat, Calendar } from "lucide-react";
...
export default function RecipeCard({ recipe, isFavorited = false, onClick }: RecipeCardProps) {
  ...
  const imageUrl = recipe.permanent_url || recipe.permanentUrl || recipe.image_url || recipe.imageUrl || '';
        ...
        >
          {user && (
            <div className="absolute top-2 right-2 flex gap-2">
              ...
              >
                <Calendar className="h-5 w-5 text-gray-500 hover:text-primary" />
