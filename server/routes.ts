    ...
    try {
      ...
      if (recipeId < 0) {
        ...
        const transformedRecipe = {
          ...
          instructions: Array.isArray(recipeData.instructions) ? JSON.stringify(recipeData.instructions) : '{}',
          tags: Array.isArray(recipeData.tags) ? JSON.stringify(recipeData.tags) : '{}',
